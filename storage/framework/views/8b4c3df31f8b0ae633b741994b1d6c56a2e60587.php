...
<head>
    ...
    <?php echo HTML::style('front_assets/css/pages/page_error3_404.css'); ?>
        ...
        <div class="col-md-12">
            <div class="service-block-in service-or">
                ...
                <p>The page you requested could not be found. However, the requested resource may be available again in
                    the future.</p>
                <a class="btn-u btn-brd btn-u-light" href="<?php echo e(route('dashboard.index')); ?>"> Go back to Employee
                    Dashboard</a>
...
<script type="text/javascript">
    $.backstretch([
        '<?php echo URL::asset("front_assets/img/blur/img1.jpg"); ?>'

    ])
</script>
<!-- JS Customization -->
<?php echo HTML::script('front_assets/js/custom.js'); ?>

<?php echo HTML::script('front_assets/js/app.js'); ?>
...
</html> <?php /**PATH /var/www/html/hr/resources/views/front/errors/404.blade.php ENDPATH**/ ?>