...
<div class="container">
    ...
    <div class="reg-block">
        ...
        <div class="reg-block-header">
            ...
            <h2><img src="<?php echo e($appSetting->logo_image_url); ?>" height="50px"></h2>
            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="employee">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" name="password"
                                       placeholder="<?php echo e(trans('core.password')); ?>"
                                       required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="forget-password">
                        ...
                        <p>
                            no worries, click <a style="color:#F44336" href="javascript:;" id="forget-password">
                                here </a>
                ...
                <!-- BEGIN FORGOT PASSWORD FORM -->
                    <?php echo Form::open(['url' => '', 'method' => 'post','class'=>'forget-form', 'style' => "display: none"]); ?>
                ...
                <div class="tab-pane fade" id="manager">
                    <?php echo Form::open(array('url' => '', 'class' => 'login-form-admin')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <button type="submit" class="btn-u btn-block input-group" id="submitbuttonAdmin"
                                    onclick="loginAdmin(); return false;"><?php echo app('translator')->get('core.btnLogin'); ?></button>
                        </div>
                    </div>
                    <hr>
                    <div class="forget-password">
                        <h4>Forgot your password?</h4>
                        <p>
                            no worries, click <a style="color:#F44336" href="javascript:;" id="forget-password-admin">
                                here </a>
                            to reset your password.
                        </p>
                    </div>
                ...
                <!-- END ADMIN LOGIN FORM -->
                    ...
                    <?php echo Form::open(['url' => '', 'method' => 'post','class'=>'forget-form-admin', 'style' => "display: none"]); ?>
...
<?php echo HTML::script("assets/admin/layout/scripts/app.js"); ?>
...
<script>
    function login() {
        $.easyAjax({
            url: "<?php echo route('login_check'); ?>",
            type: "POST",
    ...
    function forgetPassword() {
        $.easyAjax({
            url: "<?php echo route('front.forget_password'); ?>",
            type: "POST",
    ...
    function forgetPasswordAdmin() {
        $.easyAjax({
            url: "<?php echo route('admin.forget_password'); ?>",
            type: "POST",
...
<?php /**PATH /var/www/html/hr/resources/views/front/login.blade.php ENDPATH**/ ?>