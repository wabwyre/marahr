        ...
        <div class="page-toolbar no-print">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    ...
                    <li>
                        <a href="<?php echo e(url('admin/downloadSummary').'/'.$m.'/'.$y); ?>"><i class="fa fa-print"></i> Download To Excel
                        </a>
                    </li>
                    <?php endif; ?>
...
<br>
    <div class="portlet light bordered no-print">
        <div class="portlet-body">
            <div class="table-toolbar">
                <form method="post" action="<?php echo e(url('admin/payrollSummary')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row ">
    ...
    <div class="portlet light">
        <div class="portlet-body">
            <?php echo $__env->make('admin.reports.summary-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.adminlayouts.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hr/resources/views/admin/reports/summary.blade.php ENDPATH**/ ?>