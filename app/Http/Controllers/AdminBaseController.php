...
class AdminBaseController extends \App\Http\Controllers\Controller
{
    ...
    public function __construct()
    {
        ...
        $this->setting->currency = is_null($this->setting->currency) ? 'KES': $this->setting->currency;
        $this->setting->currency_symbol = is_null($this->setting->currency_symbol) ? 'kes' : $this->setting->currency_symbol;
