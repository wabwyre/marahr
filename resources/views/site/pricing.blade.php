...
@section("content")
    <section id="features">
        <div class="col-lg-10 col-lg-offset-1"Monthly Plans>
            <div class="container">
                <div class="">
                    <h2>Pricing Plans</h2>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {{--<p><small><strong>Note: </strong> Discounted rates are under <span style="color: #EF4836; font-weight: bold">Christmas Offer</span> and valid until <strong>10th January, 2015</strong> only.</small></p>--}}
                            <p>&nbsp;</p>
                                        ...
                                        <div class="col-md-3 col-md-offset-4">
                                            <div class="price-column-container border-active">
                                                ...
                                                <div class="price-table-pricing">
                                                    <h3><sup class="price-sign">{{ $setting->currency_symbol }}</sup>{{ $plan->annual_price }}</h3>
                                                    <br>
                                                    <h4>({{ $plan->annual_price/100 }} $)</h4>
                                                    <p>per year</p>
                                                </div>
