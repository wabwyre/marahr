                ...
                <ul class="nav navbar-nav">
                    ...
                    @if(isset($loggedAdmin->company) && $loggedAdmin->type !=='superadmin')
                        @if ($loggedAdmin->company->license_expired  == 0)
                            ...
                            <li class="menu-dropdown classic-menu-dropdown {{ isset($hrMenuActive) ? $hrMenuActive : '' }}">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    ...
                                    @if($loggedAdmin->type=='superadmin' || $loggedAdmin->company->payroll_feature==1)
                                        ...
                                        <li class="nav-item {{ isset($approve) ? $approve : ''}}">
                                            <a class="nav-link"
                                               href="{{ url('admin/approvePayroll') }}">
                                                &nbsp; {{$loggedAdmin->company->currency_symbol}} &nbsp;
                                        ...
                                        <li class="nav-item {{ isset($makePayment) ? $makePayment : ''}}">
                                            <a class="nav-link"
                                               href="{{ url('admin/makePayments') }}">
                                                &nbsp; {{$loggedAdmin->company->currency_symbol}} &nbsp;
                            ...
                            <li class="menu-dropdown classic-menu-dropdown {{ isset($reportActive) ? 'active' : '' }}">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item {{ isset($reportActive) ? $reportActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/payrollSummary')}}"><i class="fa  fa-check"></i>Payroll Summary</a>
                                    </li>
                                    <li class="nav-item {{ isset($markAttendanceActive) ? $markAttendanceActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/p9a')}}"><i class="fa  fa-check"></i>P9A</a>
                                    </li>
                                    <li class="nav-item {{ isset($markAttendanceActive) ? $markAttendanceActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/statutoryDeductions')}}"><i class="fa  fa-check"></i>Statutory Deductions</a>
                                    </li>
                                    <li class="nav-item {{ isset($markAttendanceActive) ? $markAttendanceActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/paymentShedule')}}"><i class="fa  fa-check"></i>Payments Shedule</a>
                                    </li>
                                    <li class="nav-item {{ isset($markAttendanceActive) ? $markAttendanceActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/employeeReport')}}"><i class="fa  fa-check"></i>Employees Report</a>
                                    </li>

                                    <li class="nav-item {{ isset($reportActive) ? $reportActive : ''}}">
                                        <a class="nav-link" href="{{url('admin/payrollVariations')}}"><i class="fa  fa-check"></i>Payroll Variations</a>
                                    </li>
                                </ul>
                            </li>
