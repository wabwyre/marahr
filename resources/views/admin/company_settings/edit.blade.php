            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">KRA PIN: <span class="required">  * </span></label>

                            <div class="col-md-6">
                                <input type="text" class="form-control" name="pin" placeholder="Company KRA PIN"
                                       value="{{ $company->pin}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            <label class="col-md-2 control-label">Nssf Rate: </label>
                            <div class="col-md-6">

                                <select class="select2me form-control" name="nssf_rate" id="select_lang">
                                    <option value="0" >Old (200)</option>
                                    <option value="1" @if($company->nssf_rate == 1) selected="selected" @endif>New (graduated)</option>
                                </select>
                            </div>
                        </div>
