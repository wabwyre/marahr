            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Sir Name <span
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="PIN" class="form-control uppercase" value="{{$employee->PIN}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">NSSF Number </label>

                            <div class="col-md-9">
                                <input type="text" name="NSSF" class="form-control uppercase" value="{{$employee->NSSF}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">NHIF Number </label>

                            <div class="col-md-9">
                                <input type="text" name="NHIF" class="form-control uppercase" value="{{$employee->NHIF}}">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="portlet light bordered ">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        ...
                        {{-- <div class="form-group">
                            <label class="col-md-3 control-label">{{trans('core.Transaction Type')}}</label>

                            <div class="col-md-9">
                                <input type="text" name="transaction_type_code" class="form-control"
                                       value="{{isset($employee->bank_details->transaction_type_code) ? $employee->bank_details->transaction_type_code : '' }}">
                            </div>
                        </div> --}}
                        <div class="form-group">
                            <label class="col-md-3 control-label">{{trans('Transaction Type Code')}}</label>

                            <div class="col-md-9">
                                <select class="form-control" name="transaction_type_code" required>
                                    <option value="">Select type</option>
                                    <option value="LBT" @if(isset($employee->bank_details->transaction_type_code) && ($employee->bank_details->transaction_type_code=='LBT')) selected @endif>{{ __('LBT') }}</option>
                                    <option value="BT" @if(isset($employee->bank_details->transaction_type_code) && ($employee->bank_details->transaction_type_code=='BT')) selected @endif>{{ __('BT') }}  </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="payment_type">
                                    ...
                                    <option value="EFT" @if(isset($employee->bank_details->payment_type) && $employee->bank_details->payment_type =='EFT') selected @endif> EFT </option>
                                    <option value="IFT" @if(isset($employee->bank_details->payment_type) && $employee->bank_details->payment_type =='IFT') selected @endif> IFT  </option>
