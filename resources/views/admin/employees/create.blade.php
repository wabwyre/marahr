                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ trans('core.father_name')}} <span
                                                class="required">* </span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="id_number" placeholder="Id Number" class="form-control" value="{{old('id_number')}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="PIN" placeholder="PIN Number" class="form-control uppercase" value="{{ old('PIN') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="NSSF" placeholder="NSSF" class="form-control uppercase" value="{{ old('NSSF') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="NHIF" placeholder="NHIF" class="form-control uppercase" value="{{ old('NHIF') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">{{ trans('transaction_type_code')}}</label>

                                    <div class="col-md-9">
                                        <select name="transaction_type_code" class="select2me form-control">
                                            {{-- <select class="select2me form-control" name="designation" id="designation"> --}}
                                        {{-- <input type="text" class="form-control" name="transaction_type_code"
                                               placeholder="{{ trans('transaction_type_code')}}" value="{{old('transaction_type_code')}}"> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="payment_type" class="select2me form-control">
