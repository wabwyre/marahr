        ...
        <div class="page-toolbar no-print">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    ...
                    @if(isset($reports))
                    <li>
                        <a href="{{ url('admin/downloadVariations').'/'.$m.'/'.$y }}"><i class="fa fa-print"></i> Download To Excel
                        </a>
                    </li>
                    @endif
                </ul>
...
<br>
    <div class="portlet light bordered no-print">
        <div class="portlet-body">
            <div class="table-toolbar">
                <form method="post" action="{{ url('admin/payrollVariations') }}">
                    @csrf
                    <div class="row ">
    ...
    <div class="portlet light">
        <div class="portlet-body">
            @include('admin.reports.payroll-view')
        </div>
    </div>
    <!-- @endif -->
@stop
